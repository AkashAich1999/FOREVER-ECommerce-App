  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
        ...
        if (response.data.success) {
            ...
            // 1. Save token in state (for App.jsx)
            setToken(token);

            // 2. Save token in localStorage (for Refresh Persistence)
    ...
    <div className="min-h-screen flex items-center justify-center w-full">
        <div className="bg-white shadow-md rounded-lg px-8 py-6 max-w-md">
            ...
            <form onSubmit={onSubmitHandler}>
                ...
                <button disabled={loading} className="mt-2 w-full py-2 px-4 rounded-md text-white bg-black disabled:opacity-50" type="submit">
...
/*
    ...
    What it means :
    disabled is a Native HTML Boolean Attribute.

    When disabled={true}, the button:
    1. Cannot be clicked.
    2. Does not submit the form.
    3. Does not fire onClick / onSubmit again.

    Is automatically treated as inactive by the browser.    
*/