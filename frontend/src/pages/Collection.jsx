...
const Collection = () => {
  ...
  const applyFilter = () => {
    let productsCopy = products.slice();  // This makes a shallow copy of the original products array so we don’t modify the original products array.
  ...
  return (
    <div className="flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t">
      ...
      <div className="min-w-60">
        ...
        {/* Category Filter */}
        <div className={`border border-gray-300 py-3 pl-3 mt-6 ${showFilter ? '' : 'hidden'} sm:block`}>
        ...
        {/* SubCategory Filter */}
        <div className={`border border-gray-300 py-3 pl-3 my-5 ${showFilter ? '' : 'hidden'} sm:block`}>
